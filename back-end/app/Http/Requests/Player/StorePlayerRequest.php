...
class StorePlayerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'jersey_number' => ['required', 'integer', 'min:1', 'max:99'],  // was nullable
            'position'      => ['required', 'string', 'max:50'],            // was nullable
            'date_of_birth' => ['nullable', 'date', 'before:today'],        // stays nullable
        ];
    }
